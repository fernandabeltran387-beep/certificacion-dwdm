...
📷 [INSERTAR: dwdm6.png — Resultado del ping desde CMD de Windows a 192.168.1.101 (DWDM 1): 3 paquetes enviados, 3 recibidos, 0% pérdida, tiempo <1ms. Y ping a 192.168.1.102 (DWDM 2): 2 paquetes enviados, 2 recibidos, 0% pérdida]
...
⚠️ Precaución: nunca mirar directamente hacia un conector óptico sin verificar previamente que el láser está apagado (TxEnable = OFF en el NMS del HT6000). Los láseres de esta maqueta operan en la banda C (~1550 nm, invisible al ojo humano).
...
📷 [INSERTAR: dwdm5.png — Pantalla del OSA RxT-1200 mostrando el espectro DWDM con los picos de los 8 canales activos. Incluir la imagen donde se observan los canales entre ~1543 nm y 1570 nm con sus potencias individuales]
...
📷 [INSERTAR: dwdm5.png (imagen del CMD con iperf3 -s) — Servidor iperf3 escuchando en puerto 5201, mostrando la sesión aceptada desde 192.168.1.11, con transferencias de ~112 MB/s por intervalo de 1 segundo, throughput estable en ~942 Mbits/sec durante 10 segundos, total transferido: 1,10 GBytes]




📷 [INSERTAR: dwdm2.png o imagen CMD — Cliente iperf3 conectando a 192.168.1.10, puerto 5201, reportando throughput de sender y receiver: 942 Mbits/sec]
...
📷 [INSERTAR: dwdm2.png — System Alarm Log del HT6000 mostrando las alarmas: entradas 103–128 con OLP1+1 Optical PowerAlarm (slots 08) y EDFA01 Optical PowerAlarm/Gain deviationAlarm (slots 09 y 17)]
...
⚠️ Las macrocurvaturas son especialmente perjudiciales en sistemas DWDM porque generan pérdidas dependientes de la longitud de onda, pudiendo afectar canales específicos de forma selectiva.
